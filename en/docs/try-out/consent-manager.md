...
9. Add a custom policy. Follow the instructions given below according to the API Manager version you are using:
    ...
    ??? note "Click here to see how to add a custom policy if you are using API Manager 4.0.0..."
        ...
        1. Go to **Develop > API Configurations > Runtime** using the left menu pane.<br><br>![select_runtime](../assets/img/get-started/quick-start-guide/select-runtime.png)
            
        2. Click the edit button under **Request > Message Mediation**.<br><br>![message_mediation](../assets/img/try-out/consent-manager/message_mediation.png)
