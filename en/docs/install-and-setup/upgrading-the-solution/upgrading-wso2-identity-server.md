...
5. Download the latest updates for `wso2-obiam-toolkit-cds-1.0.0`. For more information, see [Getting WSO2 Updates](../setting-up-servers.md#getting-wso2-updates).
